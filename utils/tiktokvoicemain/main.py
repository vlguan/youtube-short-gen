...
if __name__ == "__main__":
    main()
    # print(voices)
    # tts(session_id="73782eef66d5ab64bf83342be9623375", text_speaker="en_us_stormtrooper", req_text="Matthew, did you know rome is just a figment of your imagination", filename="test.mp3", play=True)
